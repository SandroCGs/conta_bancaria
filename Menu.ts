        ...
        switch (opcao) {
            case 1:
                ...
                switch (tipo) {
                    case 1:
                        ...
                        break;
                    case 2:
                        console.log("Digite o dia de anivesário da Conta Poupança: ");
            ...
            case 4:
                ...
                if (conta != null){
                    ...
                    console.log(colors.fg.red, "\A conta numero: " + numero +
...
export function sobre(): void {
    ...
    console.log("Sandro Costa Gomes - sandrolp41@hotmail.com");
